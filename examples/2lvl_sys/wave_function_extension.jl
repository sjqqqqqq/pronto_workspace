...
@kwdef struct WFExtension <: PRONTO.Model{9,1}
    kl::Float64
    kr::Float64
    T::Float64 
end
...
@define_Q WFExtension I(9)
@define_R WFExtension kr*I(1)
PRONTO.Pf(θ::WFExtension,α,μ,tf) = SMatrix{9,9,Float64}(I(9))

resolve_model(WFExtension)

## Compute the optimal solution

θ = WFExtension(kl=0.01,kr=10,T=100)
τ = t0,tf = 0,θ.T
ψ1 = [1;0]
ψ2 = [0;1]
