...
@kwdef struct Flux3ExZ <: PRONTO.Model{13,1}
    kl::Float64 = 0.01
    kq::Float64 = 0.0
    T::Float64 
end

@define_f Flux3ExZ begin
    E0 = 0.0
    E1 = 0.74156
    E2 = 4.017875
    H0 = diagm([E0, E1, E2])
...
@define_Q Flux3ExZ I(13)
@define_R Flux3ExZ I(1)
PRONTO.Pf(θ::Flux3ExZ,α,μ,tf) = SMatrix{13,13,Float64}(I(13))

resolve_model(Flux3ExZ)

## Compute the optimal solution

θ = Flux3ExZ(kl=0.01,kq=0.1,T=33.0)
τ = t0,tf = 0,θ.T
ψ1 = [1;0;0]
ψ2 = [0;1;0]
...
file = matopen("Uopt_Flux_Z.mat", "w")
write(file, "Uopt_Z", us)
close(file)